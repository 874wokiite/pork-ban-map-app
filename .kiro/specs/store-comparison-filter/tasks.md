...
- [ ] 2.2 店舗リストのマッチング・ソート機能を作成
  - 複数店舗のマッチ度を一括計算する機能
  - マッチ度の高い順に店舗をソートする機能
  - AI分析データがない店舗を除外する機能
  - _Requirements: 2.5, 3.3_

- [ ] 2.3 マッチング計算のユニットテストを作成
  - 各軸の差分計算が正しいことを検証
  - 総合マッチ度の計算が正しいことを検証
  - ソート順が正しいことを検証
  - データなし店舗の除外が正しいことを検証
...
- [ ] 3. スペクトラムバーコンポーネントの実装
- [ ] 3.1 読み取り専用スペクトラムバーを作成
  - 水平バーで評価値の位置を視覚化する表示
...
- [ ] 6. 店舗詳細モーダルへのスペクトラムバー統合
- [ ] 6.1 既存の店舗詳細モーダルにスペクトラムバーを追加
